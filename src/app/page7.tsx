...
export default function IdleCultivationGameWithExploreBroken() {
      ...
      activities: [
        {
          ...
          icon: Leaf,
          result: "You gathered 5 Spirit Herbs.",
        },
        {
          name: "Hunt Beasts",
          time: "4 hours",
          ...
          icon: Sword,
          result: "You defeated a wild beast and obtained 2 Beast Cores.",
        },
        {
          name: "Explore Ruins",
          time: "6 hours",
          ...
          icon: ScrollText,
          result: "You discovered an Ancient Scroll.",
        },
      ],
    };
            ...
            <CardContent className="space-y-2">
              {currentLocationData.activities.map((activity, index) => (
                <div
                  ...
                  onClick={() => {
                    setEventLog((prev) => [...prev, activity.result]);
                  }}
                >
                  <div className="flex items-center gap-3">
                    <activity.icon className="w-4 h-4 text-purple-400" />
