...
export default function IdleCultivationGame2() {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col text-foreground dark">
      ...
      <div className="flex flex-1">
        {/* Stats Panel */}
        <div className="w-64 bg-black border-r border-slate-800/50 p-3 space-y-3 fixed left-0 top-32 h-[calc(100vh-8rem)] overflow-hidden">
        ...
        {/* Navigation Sidebar */}
        <div className="w-48 bg-black border-r border-slate-800/50 p-3 fixed left-64 top-32 h-[calc(100vh-8rem)] overflow-hidden">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <Card className="bg-black border-slate-700/50">
              <CardHeader className="pb-2">
                <CardTitle className="text-lg text-purple-300">You</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                ...
                <div className="grid grid-cols-3 gap-2 text-xs">
                  <div className="text-center">
                    ...
                    <div className="text-purple-300 font-bold">15</div>
                  </div>
                  <div className="text-center">
                    <div className="text-slate-400">DEX</div>
                    <div className="text-violet-300 font-bold">12</div>
                  </div>
                  <div className="text-center">
                    <div className="text-slate-400">SPD</div>
                    <div className="text-purple-300 font-bold">10</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-black border-slate-700/50">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="grid grid-cols-3 gap-2 text-xs">
                  <div className="text-center">
                    <div className="text-slate-400">STR</div>
                    <div className="text-red-300 font-bold">18</div>
                  </div>
                  <div className="text-center">
                    <div className="text-slate-400">DEX</div>
                    <div className="text-red-300 font-bold">20</div>
                  </div>
                  <div className="text-center">
                    <div className="text-slate-400">SPD</div>
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col text-foreground dark">
      {/* ... existing header and time bar code ... */}

      <div className="flex flex-1">
        {/* ... existing sidebars code ... */}
