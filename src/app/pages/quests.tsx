        ...
        <Card className="bg-black border-slate-700/50">
          ...
          <CardContent className="space-y-3">
            {activeQuests.map((quest) => (
              <div key={quest.id} className="p-3 rounded-lg bg-slate-900/50 border border-slate-700/50">
                ...
                <Progress value={quest.progress} className="h-1.5 bg-slate-800 [&>div]:bg-accent-violet mt-2" />
              </div>
            ))}
          </CardContent>
        </Card>
