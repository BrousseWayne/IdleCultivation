...
export default function IdleCultivationGameWithOtherExplore() {
            ...
            <CardContent className="space-y-2">
              {currentLocationData.locations.map((location, index) => (
                <button
                  ...
                  className="w-full flex items-center gap-3 p-2 rounded-lg bg-slate-900/50 border border-slate-700/50 hover:border-purple-500/30 transition-colors text-left"
                >
