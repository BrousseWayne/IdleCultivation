...
export default function IdleCultivationGame5() {
                    ...
                    {hasEvent && (
                      <div
                        className={`absolute bottom-1 left-1/2 transform -translate-x-1/2 w-1 h-1 rounded-full ${
                          hasUpcomingEvent ? "bg-violet-400" : "bg-slate-400"
                        }`}
                      ></div>
                    )}
                  </button>
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col text-foreground dark">
      ...
      <div className="flex flex-1">
        {/* Stats Panel */}
        <div className="w-64 bg-black border-r border-slate-800/50 p-3 space-y-3 sticky top-32 h-[calc(100vh-8rem)] overflow-y-auto">
        ...
        {/* Navigation Sidebar */}
        <div className="w-48 bg-black border-r border-slate-800/50 p-3 sticky top-32 h-[calc(100vh-8rem)] overflow-y-auto">
