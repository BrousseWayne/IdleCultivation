...
import type { GamePhase, NavigationItem } from "@/game/types/domain";
...
const CONTENT = {
  ...
  "self.title": { default: "Self" },
  "self.label.age": { default: "Age" },
  "self.label.body": { default: "Body" },
  "self.label.belly": { default: "Belly" },
  "self.label.money": { default: "Money" },
  "self.label.income": { default: "Income" },
  "self.label.upkeep": { default: "Upkeep" },
  ...
  "queue.resting": { default: "Resting" },
  "queue.idleHint": { default: "day's work done" },
  "queue.clear": { default: "Clear schedule" },
  "queue.free": { default: "free" },
  "queue.planDay": { default: "plan the day" },
